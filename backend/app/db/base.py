...
from app.models import rbac, user, lead, booking, payment, audit, status, integration, messaging, activity, settings, custom_fields, master_options, attendance, files, notes, embed_widget  # noqa: E402,F401
